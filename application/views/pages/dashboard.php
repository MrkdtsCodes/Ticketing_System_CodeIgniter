        ...
        <div class="p-8 mx-auto bg-white rounded-2xl shadow-sm border border-slate-200">
            ...
            <div class="mb-4 flex w-full flex-row-reverse justify-between items-center gap-4 bg-white rounded-lg">
                ...
                <div class="dt-search-wrapper flex items-center gap-3 flex-row">
                    <!-- FILTER ICON -->
                    <div id="filterbtn" class="filterbtn order-1 flex items-center justify-center text-white bg-blue-500 p-3 rounded-lg cursor-pointer">
                ...
                <div class="flex items-center justify-end gap-2 flex-row flex-wrap">
                    ...
                    <div class="navsearch-tab px-6 py-2 rounded-md text-sm font-medium bg-slate-100 border border-slate-200 text-slate-600
                        hover:bg-slate-500 hover:text-white transition cursor-pointer" data-filter="For Approval">
                        For Approval
                    </div>

                    <div class="navsearch-tab px-6 py-2 rounded-md text-sm font-medium bg-slate-100 border border-slate-200 text-slate-600
                        hover:bg-slate-500 hover:text-white transition cursor-pointer" data-filter="To Assign">
                        To Assign
                    </div>

                    <div class="navsearch-tab px-6 py-2 rounded-md text-sm font-medium bg-slate-100 border border-slate-200 text-slate-600
                        hover:bg-slate-500 hover:text-white transition cursor-pointer" data-filter="Assigned">
                        Assigned
                    </div>

                    <div class="navsearch-tab px-6 py-2 rounded-md text-sm font-medium bg-slate-100 border border-slate-200 text-slate-600
                        hover:bg-slate-500 hover:text-white transition cursor-pointer" data-filter="On going">
                        On going
                    </div>

                    <div class="navsearch-tab px-6 py-2 rounded-md text-sm font-medium bg-slate-100 border border-slate-200 text-slate-600
                        hover:bg-slate-500 hover:text-white transition cursor-pointer" data-filter="For Testing">
                        For Testing
                    </div>
            ...
            <div id="showFilter" style="display: none" class="showFilter mb-4 flex w-full justify-center p-4 border border-black items-center gap-4 bg-white rounded-lg">
                 ...
                 <!-- Status Dropdown -->
                <div class="">
                    <select name="" id="statusTab" class="w-full border border-gray-300 rounded-lg p-3 text-sm bg-gray-50 appearance-none text-gray-700 focus:bg-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors cursor-pointer">
                    ...
                    <?php foreach ($crtdTickets as $ticket): ?>
                        ...
                        <tr class="bg-white hover:bg-slate-50 transition border border-slate-100 rounded-lg">
                            ...
                            <td class="px-4 py-3" data-search="<?= $ticket['status'] ?>">
                                <div style="color:<?php
                                                    if ($s === 'open') echo '#4ade80';
                                                    elseif ($s === 'in progress') echo '#3d76fb';
                                                    elseif ($s === 'for approval') echo '#94a3b8';
                                                    elseif ($s === 'closed') echo '#ef4444';
                                                    else echo '#64748b';
                                                    ?>;"
                        ...
                        color: <?php
                            ...
                            <td class="px-4 py-3 flex justify-center items-center">
                                <a href="<?= base_url('tickets/view/' . $ticket['id']) ?>">
                                    <button class="text-slate-500 hover:text-slate-900 hover:bg-slate-100 p-2 rounded-lg transition">
